...
- **Node.js Version**: Currently tests on Node.js 22.x (configurable for multiple versions)
- **Linting**: Runs ESLint to check code quality
- **Formatting**: Checks Prettier formatting
- **Testing**: Runs Vitest test suite with coverage reporting
- **Building**: Builds the project to ensure production readiness
